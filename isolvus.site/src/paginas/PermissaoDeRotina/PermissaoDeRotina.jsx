...
function PermissaoDeRotina() {
   ...
   return (
      <>
         ...
         <div className="container-fluid Containe-Tela permissao-rotina-page">
            ...
            <p className="permissao-section-title">Aviso</p>
            <div className="permissao-card permissao-info-banner d-flex align-items-center">
               <h6 className="m-0">
                  <span>
            ...
            <p className="permissao-section-title">Resultados</p>
            <div className="permissao-card permissao-table-card">
                  <table className="table tablefont table-hover mb-0 permissao-table">
                     <thead>
                        <tr>
                        ...
                        {loadingUsuarios ? (
                           ...
                           usuarios.map((usuario) => (
                              <tr
                                 ...
                                 className="linha-grid-desktop-analisedespesa permissao-row-clickable"
                                 role="button"
                                 tabIndex={0}
                              >
